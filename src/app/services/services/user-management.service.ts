...
import { changeUserRole } from '../fn/user-management/change-user-role';
import { ChangeUserRole$Params } from '../fn/user-management/change-user-role';
...
import { getUserById } from '../fn/user-management/get-user-by-id';
import { GetUserById$Params } from '../fn/user-management/get-user-by-id';
...
export class UserManagementService extends BaseService {
  ...
  static readonly ChangeUserRolePath = '/users/{userId}/roles/{roleId}';
   ...
   */
  changeUserRole$Response(params: ChangeUserRole$Params, context?: HttpContext): Observable<StrictHttpResponse<User>> {
    return changeUserRole(this.http, this.rootUrl, params, context);
  }
   ...
   * This method doesn't expect any request body.
   */
  changeUserRole(params: ChangeUserRole$Params, context?: HttpContext): Observable<User> {
    return this.changeUserRole$Response(params, context).pipe(
